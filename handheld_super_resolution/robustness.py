...
def compute_robustness(ref_img, comp_imgs, flows, options, params):
    ...
    if r_on : 
        ...
        compute_local_stats[(n_images+1, rgb_imshape_y, rgb_imshape_x), (3, 3)](
            cuda_ref_rgb_img, cuda_comp_rgb_imgs,
...
@cuda.jit
def compute_local_stats(ref_rgb_img, comp_rgb_imgs,
                        ref_local_stats, comp_local_stats):
    """
